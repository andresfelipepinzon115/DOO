...
public class DisponibilidadDTO {
    ...
    public DisponibilidadDTO(final int id, final String nombre,final LocalDateTime fecha, final LocalDateTime HoraInicio, final LocalDateTime HoraFin, final AulaDTO aula) {
        setId(id);
        setFecha(fecha);
